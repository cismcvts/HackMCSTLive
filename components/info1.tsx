...
useGSAP (() => {
  ...
  return (
    <div id="about" className='bg-black text-white fontarchytype info1txt text-center pt-9 pb-9 overheadDv d-flex flex-column justify-content-center align-items-center my-4'>
