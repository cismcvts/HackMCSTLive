              ...
              <div className="text-left space-y-6">
                <div>
                  ...
                  <ul className="list-none space-y-2">
                    <li>❌ <strong>AI-Generated Code</strong> – Copy-pasting AI-generated code into your project without significant modification or understanding.</li>
                    <li>❌ <strong>AI-Generated Project Structures</strong> – Using AI to generate entire files, full project templates, or core algorithmic solutions.</li>
                    <li>❌ <strong>AI-Based Debugging Without Learning</strong> – If AI fixes errors for you and you don't understand why, that's a problem.</li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-green-500 mb-2">Permitted Actions</h3>
                  <ul className="list-none space-y-2">
                    <li>✔️ <strong>Learning Before the Event</strong> – You can study documentation, tutorials, or concepts beforehand, but not write actual project code.</li>
                    <li>✔️ <strong>Using Public Libraries & APIs</strong> – You may use third-party libraries, frameworks, and APIs, as long as your implementation is original and done during the event.</li>
                    <li>✔️ <strong>Code from Official Documentation</strong> – Small snippets (e.g., syntax examples from official docs) are fine, but they cannot form a significant portion of your project.</li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-red-500 mb-2">Prohibited Actions</h3>
                  <ul className="list-none space-y-2">
                    <li>❌ <strong>Pre-Written Code</strong> – No part of the project's codebase may be written before the hackathon officially begins.</li>
                    <li>❌ <strong>Pre-Built Projects</strong> – Forking or modifying an existing personal or public project (even your own) is not allowed.</li>
                    <li>❌ <strong>Reusing Old Code</strong> – You may not copy-paste code from previous projects, whether written by you or someone else.</li>
                    <li>❌ <strong>Hidden Preparation</strong> – Writing pseudocode that is so detailed it can be quickly converted into working code is prohibited.</li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-yellow-500 mb-2">Rule Enforcement</h3>
                  <ul className="list-none space-y-2">
                    <li>⚠️ <strong>Code Audits</strong> – Judges will inspect commit history to ensure all work was done during the hackathon.</li>
                    <li>⚠️ <strong>Live Coding Checks</strong> – Teams may be asked to demonstrate their project live to confirm functionality.</li>
                    <li>⚠️ <strong>Technical Questioning</strong> – Judges will ask how specific parts of your code were written. If you can't explain it, penalties will apply.</li>
                  </ul>
                </div>
                <div>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-purple-500 mb-2">📊 GitHub Setup Instructions</h3>
